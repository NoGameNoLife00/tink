...
class AddressBook PROTOBUF_FINAL :
 ...
 public:
  ...
  public:
  void clear_people();
  const ::tutorial::Person& people() const;
  ::tutorial::Person* release_people();
  ::tutorial::Person* mutable_people();
  void set_allocated_people(::tutorial::Person* people);
  private:
  const ::tutorial::Person& _internal_people() const;
  ::tutorial::Person* _internal_mutable_people();
  public:
  void unsafe_arena_set_allocated_people(
      ::tutorial::Person* people);
  ::tutorial::Person* unsafe_arena_release_people();
...
// .tutorial.Person people = 1;
inline bool AddressBook::_internal_has_people() const {
  return this != internal_default_instance() && people_ != nullptr;
}
...
inline const ::tutorial::Person& AddressBook::_internal_people() const {
  const ::tutorial::Person* p = people_;
  return p != nullptr ? *p : *reinterpret_cast<const ::tutorial::Person*>(
      &::tutorial::_Person_default_instance_);
}
inline const ::tutorial::Person& AddressBook::people() const {
  // @@protoc_insertion_point(field_get:tutorial.AddressBook.people)
  return _internal_people();
}
inline void AddressBook::unsafe_arena_set_allocated_people(
    ::tutorial::Person* people) {
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(people_);
  }
  people_ = people;
  if (people) {
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:tutorial.AddressBook.people)
}
inline ::tutorial::Person* AddressBook::release_people() {
  
  ::tutorial::Person* temp = people_;
  people_ = nullptr;
  if (GetArena() != nullptr) {
...
inline ::tutorial::Person* AddressBook::unsafe_arena_release_people() {
  // @@protoc_insertion_point(field_release:tutorial.AddressBook.people)
  
  ::tutorial::Person* temp = people_;
  people_ = nullptr;
  return temp;
}
inline ::tutorial::Person* AddressBook::_internal_mutable_people() {
  
  if (people_ == nullptr) {
    auto* p = CreateMaybeMessage<::tutorial::Person>(GetArena());
    people_ = p;
  }
  return people_;
}
inline ::tutorial::Person* AddressBook::mutable_people() {
  // @@protoc_insertion_point(field_mutable:tutorial.AddressBook.people)
  return _internal_mutable_people();
}
inline void AddressBook::set_allocated_people(::tutorial::Person* people) {
  ...
  if (people) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      ::PROTOBUF_NAMESPACE_ID::Arena::GetArena(people);
  ...
  people_ = people;
  // @@protoc_insertion_point(field_set_allocated:tutorial.AddressBook.people)
}
